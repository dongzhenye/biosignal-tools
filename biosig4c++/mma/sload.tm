...
:Evaluate: sload::usage = "data = sload[filename, {ne,ng,ns}] load data sweeps into mathematica workspace.
 ...
 The output ist a list of three elements, the first containing the 2-dim array of data samples, 
 the second contains the time axis in seconds, and the third contains the header information in JSON-formated string. 
